...
[First online workshop curriculum](first-online-workshop-curriculum.md)

The curriculum is the public session plan: audience, learning objectives,
60-minute agenda, commands, facilitator notes, participant lab card, and
closeout format.
...
| Category-theory reader | `cargo run --example 05_seven_sketches`, then `cargo run --example 06_attention_scores`; use the Seven Sketches Transfer Drill and roadmap Source-Target Audit Card |
