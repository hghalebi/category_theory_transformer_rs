...
| challenge completion, evidence signal, Paper-To-Rust, optimizer state | [Rustlings Usage](https://rustlings.rust-lang.org/usage/), [Rustlings Community Exercises](https://rustlings.rust-lang.org/community-exercises/), [Adam](https://arxiv.org/abs/1412.6980), [PyTorch Adam](https://docs.pytorch.org/docs/main/generated/torch.optim.adam.Adam_class.html), [Rust Book tests](https://doc.rust-lang.org/stable/book/ch11-00-testing.html) | `challenges/typed-ai-rustlings/`, `src/challenges/papers/adam.rs`, `examples/challenge_adam.rs`, `tests/challenge_typed_ai.rs`, and `tests/paper_to_rust_adam.rs` | `cargo test --test challenge_typed_ai`; `cargo run --example challenge_adam`; explain the source claim, Rust boundary, invariant, and visible compiler, output, or test signal |
